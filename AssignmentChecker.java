...
public class AssignmentChecker {    
    public static void main(String[] args) {
        ...
        System.out.println("I do not bear responsibility of you lose marks.");
        System.out.println("This program should only be used as a reference.");
         ...
         */
        System.out.println("Problem 1: Points A, B, and C");
         ...
         */
        System.out.println("Problem 2: Displacement Vector AB");
        System.out.println("Vector AB: " + AB.toString());
        System.out.println("Vector AC: " + AC.toString());
        System.out.println("Vector BC: " + BC.toString());
        System.out.println();

        /**
         * Problem 3: Perimeter of Triangle
         */
        System.out.println("Problem 3: Perimeter of Triangle ABC");
        System.out.printf("Decimal: %.2f", AB.magnitude + BC.magnitude + AC.magnitude);
        System.out.println();
        System.out.printf("Exact: sqrt(%.0f) + sqrt(%.0f) + sqrt(%.0f)", Math.pow(AB.magnitude, 2),
         ...
         */
        System.out.println("Problem 4: Angle A of triangle ABC");
         ...
         */
        System.out.println("Problem 5: Area of Triangle ABC");
        System.out.printf("Area: sqrt(%.0f)/2", Math.pow(AB.crossProduct(AC).magnitude, 2)); // Already positive due to
                                                                                             // squaring
        System.out.println();
        System.out.println();
         ...
         * the cross product.
         */
        System.out.println("Problem 6: Volume of OABC");

        System.out.printf("Volume: %.0f/6", Math.abs(OA.dotProduct(OB.crossProduct(OC))));
        System.out.println();
        System.out.println();
        ...
        System.out.println("Problem 7: Unit vector of median from A to BC");
        Point M = new Point(B.x + BC.x / 2, B.y + BC.y / 2, B.z + BC.z / 2);
        System.out.println("Midpoint of side: " + M);
        Vector AM = new Vector(A, M);
        System.out.println("Vector AM: " + AM);
        Vector AM_Norm = new Vector(AM.x / AM.magnitude, AM.y / AM.magnitude, AM.z / AM.magnitude);
        System.out.printf("I believe in you. You can normalize the vector. It\'s magnitude is sqrt(%s)\n",
                AM.magnitude * AM.magnitude);
        System.out.println("Decimal: " + AM_Norm);
        System.out.println("(might be off by a bit)");
        System.out.println();

        /**
         * Problem 8: Shortest distance from origin to triangle ABC (optimized method)
         */
        System.out.println("Problem 8: Shortest distance from origin to triangle ABC");
        ...
        System.out.printf("Decimal: %.3f%n", distance);
        System.out.printf("Exact form: %.0f / sqrt(%.0f)%n", Math.abs(OA.dotProduct(OB.crossProduct(OC))),
                4 * (area * area));
        System.out.println();
         ...
         */
        System.out.println("Problem 9: Unit vector of the height from A to BC");

        Vector BA = new Vector(B, A);
        Vector p9v = BA.crossProduct(BC).crossProduct(BC);
        p9v.normalize();
        System.out.println(p9v);
        System.out.println();
        ...
        System.out.println("Problem 10: Unit vector of the perpendicular bisector of BC");
        Vector p10v = BA.crossProduct(BC).crossProduct(BC);
        p10v.normalize();
        System.out.println(p10v);
        System.out.println();
         ...
         */
        System.out.println("Problem 11: Unit vector of angle bisector of <A");
